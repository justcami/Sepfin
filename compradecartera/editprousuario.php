...
<table align="center" cellspacing="5" cellpadding="5" border="3" border="1">   
		...
		<tr align="center">
			...
			<td><input type="text" class="inputcentrado" name="extracupo" value="<?php echo $fila['extracupo']?>" readonly="readonly"</td>
			<td><input type="text" name="cupodispo" style="text-align:center" value="<?php echo $fila['cupodispo']?>"></td>
			<td><input type="text" class="inputcentrado" name="potencialtdc" value="<?php echo $fila['potencialtdc']?>" readonly="readonly"</td>
