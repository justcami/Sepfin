...
<center><table border="1" class="table3">
		...
		{			
         ?>
<tr align="center"><td><b>Cedula</b><br><input type="text" name="Cedula" class="inputnomod" value="<?php echo $fila['cedula']?>" readonly="readonly" onkeydown="cedula(this)"></td><td colspan="2">Nombre<br><input type="text" class="inputnomod" name="Nombre" id="Nombre" value="<?php echo $fila['nombre']?>" readonly="readonly" onkeydown="nombre(this)"></td><td>Tasa<br><input type="text" class="inputnomod" name="Tasa" value="<?php echo $fila['tasa']?>" readonly="readonly" onkeydown="tasa(this)"></td><td>ExtraCupo<br><input type="text" class="inputnomod" name="extracupo" value="<?php echo $fila['extracupo']?>" readonly="readonly" onkeydown="extra(this)"></td><td>Cupo Disponible<br><input type="text" name="cupodispo" class="input1" value="<?php echo $fila['cupodispo']?>" onkeydown="cupo(this)"></td><td>Potencial TDC<br><input type="text" class="inputnomod" name="potencialtdc" value="<?php echo $fila['potencialtdc']?>" oreadonly="readonly" nkeydown="poten(this)"></td><td>Telefono 1<br><input type="text" name="tel1" class="input1" value="<?php echo $fila['tel1']?>" onkeydown="tela(this)"></td><td>Telefono 2<br><input type="text" name="tel2" class="input1" value="<?php echo $fila['tel2']?>" onkeydown="telb(this)"></td><td>Telefono 3<br><input type="text" name="tel3" class="input1" value="<?php echo $fila['tel3']?>" onkeydown="telc(this)"></td><td>Telefono 4<br><input type="text" name="tel4" class="input1" value="<?php echo $fila['tel4']?>" onkeydown="teld(this)"></td></tr>
